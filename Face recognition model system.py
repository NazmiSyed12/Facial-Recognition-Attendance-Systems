...
path = r"C:\Users\Nazmi\OneDrive\Desktop\cvs\ImagesFaceRecognition"

# Initialize lists to store images and their corresponding names
images = []
classNames = []
...
for cl in myList:
    ...
    if os.path.isfile(os.path.join(path, cl)) and cl.lower().endswith(('.png', '.jpg', '.jpeg', '.gif', '.bmp', '.tif')):
